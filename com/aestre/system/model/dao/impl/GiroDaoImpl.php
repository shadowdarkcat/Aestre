...
/**
 * Description of GiroDaoImpl
 *
 * @author ShadowDarkCat
 */
class GiroDaoImpl implements GiroDao {
    ...
    public function findAll() {
        return $this->getResultSet(PropertyKey::$jdbc_view_giro);
    }

    public function findById($obj) {
        $args = array($obj->getIdGiro());
        return $this->getResultSet(Utils::replaceQuery(PropertyKey::$jdbc_view_giro_id, $args))[0];
    }
    ...
    private function getResultSet($query) {
        ...
        while (@$row = mysqli_fetch_array($rs)) {
            $object[$index] = SqlUtils::getFields(FactoryGiro::newInstance(NULL), $row);
            $index++;
        }
